          ...
          <ul className="footer-list flex">
            <li>
              <a
                ...
                className="hover:text-[#0077b5] hover:bg-white transition duration-200"
              >
            ...
            <li>
              <a
                ...
                className="hover:text-[#333] hover:bg-white transition duration-200"
              >
            ...
            <li>
              <a
                href="/"
                className="hover:text-black hover:bg-white transition duration-200"
              >
            ...
            <li>
              <a
                href="/"
                className="hover:text-[#E4405F] hover:bg-white transition duration-200"
              >
